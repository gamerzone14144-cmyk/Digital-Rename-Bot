...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7742278753:AAEAi3yRcei6bOEx0hDUZCgOgqMY17d1rAY") 
    ...
    #force subs
    try:
        FORCE_SUB = int(os.environ.get("FORCE_SUB", "-1002760856435")) 
    except:
        FORCE_SUB = os.environ.get("FORCE_SUB", "Tanveer_Botz")
